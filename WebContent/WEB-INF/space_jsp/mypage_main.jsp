...
<div class="container-fluid">
	...
	<div class="row mypage_main">
			<div class="col-sm-2 ">
				<ul class="nav">
					<li class="active li_bold"><a data-toggle="tab" href="#myInfo">[내정보]</a></li>
					...
					<li class="li_bold"><a data-toggle="tab" href="#sellerWrite">[판매자]</a></li>
	...
	<div class="tab-content col-sm-10 mypage_content_row" >
		<div id="myInfo"  class="tab-pane active fade in">	
			<iframe class="mypage_iframe" src="myinfo_ckpass.do"  align="center" ></iframe>
		</div>
		<div id="myBooking" class="tab-pane fade">
			<iframe class="mypage_iframe" src="mypage_moveMypageBookingPage.do"  align="center" ></iframe>
		</div>
		<div id="myBookmark"   class="tab-pane fade">
			<iframe class="mypage_iframe" src="bookmark_findAll.do"  align="center" ></iframe>
		</div>
		<div id="myQna"   class="tab-pane fade">
			<iframe class="mypage_iframe" src="mypage_moveMypageQnAPage.do"  align="center"></iframe>
		</div>
		<div id="myClub"   class="tab-pane fade">
			<iframe class="mypage_iframe" src="myclub_findAll.do"  align="center"></iframe>
		</div>
		<div id="myReview"   class="tab-pane fade">
			<iframe class="mypage_iframe"  src="mypage_review_findAll.do"  align="center"></iframe>
		</div>
		<div id="myReceiveMessageBox"   class="tab-pane fade">
			<iframe class="mypage_iframe" src="mypage_moveMypageReceiveMessagePage.do"  align="center" ></iframe>
		</div>
		<div id="mySendMessageBox"   class="tab-pane fade">
			<iframe class="mypage_iframe" src="mypage_moveMypageSendMessagePage.do"  align="center" ></iframe>
		</div>
		<div id="mySendMessage"   class="tab-pane fade">
			<iframe class="mypage_iframe" src="mypage_moveMypageWriteMessagePage.do"  align="center"></iframe>
		</div>
